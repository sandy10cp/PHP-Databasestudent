...
?>
	<div class="container">
		<div class="content">
			<?php $nama = $_POST['carinama']; // mengambil nim dari form cari ?> 
			<h2>Pencarian Data Student &raquo; Nama: <?php echo $nama; // menampilkan nim ?></h2>
			<hr />
			
			<?php
			$sql = mysqli_query($koneksi, "SELECT * FROM mahasiswa WHERE nama LIKE '$nama%'"); // query untuk memilih entri dengan nim terpilih
			if(mysqli_num_rows($sql) == 0){
				echo '<h3><font color="red"><i>Data <b>'.$nama.'</b> tidak di temukan!</i></font></h3>';
				//header("Location: result_empty.php");
				exit();
			}else{
			...
			<table class="table table-striped table-condensed">
				...
				<tr>
					...
					<td><a href="profile.php?nim=<?php echo $row['nim']; ?>"><?php echo $row['nama']; ?></a></td>
				</tr>
				<tr>
					<th>Jenis Kelamin</th>
